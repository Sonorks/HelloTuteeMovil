...
public class navigation_activity extends AppCompatActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            ...
            case 1:
                fragment = new PreguntarFragment();
                break;
            ...
            case 2:
                ...
                break;
            case 3:
                fragment = new RecargarCuentaFragment();
                break;
            case 4:
                Cursor cLogin = manager.cargarCursorUsuarioLogeo();
                cLogin.moveToFirst();
                manager.deslogear(cLogin.getString(0));
                System.exit(0);
                break;
                }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_navigation_activity, container, false);
            return rootView;
        }
